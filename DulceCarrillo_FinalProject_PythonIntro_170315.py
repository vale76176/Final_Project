...
#dictionary: list of work contacts and their attributes
#if/else statement: If number of defibrillators >25 then print names in a text file
#user args import sys
#Calculation will be counting the number of defibrillators ordered
#output: write out my dictionary to a text file
